...
//! @LastEditTime: 2023-08-27 21:48:43
...
typedef enum
{
  ADC_Sequential_Sampling = 0,
  ADC_Simultaneous_Sampling
} ADC_sMod_e;


typedef enum
{
  ADC_BGRF_Powerdown = 0,
  ADC_BGRF_Powerup =3
} ADC_BGRF_e;
//
...
extern void ADC_setSocMode(ADC_Handle adcHandle, ADC_SocMode_e SOCMode, ADC_EN_e EnableSOCMode);
...
extern void ADC_setADCBGRFDN(ADC_Handle adcHandle, ADC_BGRF_e BGRF);

//! \brief   ADC 内核供电
extern void  ADC_setPower(ADC_Handle adcHandle, ADC_PwrMode_e pwrmode);


extern  void ADC_Read(ADC_Handle adcHandle, uint16_t *result);
