...
//! @LastEditTime: 2023-08-27 15:34:42
...
#define GPIO_GPxCTRL_QUALPRDx_NUMBITS_PER_REG 8
  ...
  typedef enum
  {
    ...
    GPIO_Number_45,      //!< Denotes GPIO number 45
    GPIO_Number_46,      //!< Denotes GPIO number 46
    GPIO_Number_47,      //!< Denotes GPIO number 47
    GPIO_Number_48,      //!< Denotes GPIO number 48
    GPIO_Number_49,      //!< Denotes GPIO number 49
