...
//! @LastEditTime: 2023-09-05 22:55:17
//! @Description:
...
typedef enum
{
    ...
    PWM_HspClkDiv_by_6= 3 ,
    PWM_HspClkDiv_by_8= 4 ,
    PWM_HspClkDiv_by_10=5,
    PWM_HspClkDiv_by_12=6,
    PWM_HspClkDiv_by_14=7
} PWM_HspClkDiv_e;
...
//! @return *
static inline void PWM_Handle PWM_init(void *pMemory, const size_t numBytes);

//! \brief  设置周期计数器最大值
static inline void PWM_set_TB_Period(PWM_Handle pwmHandle, const uint16_t period);

//! \brief  设置计数器相位值
static inline void PWM_set_TB_Phase(PWM_Handle pwmHandle, const uint16_t phase);

//! \brief  设置PWM时钟 TBCLK = SYSCLKOUT / (HSPCLKDIV × CLKDIV)
static inline void PWM_set_TB_ClkDiv(PWM_Handle pwmHandle, const PWM_ClkDiv_e clkDiv);

//! \brief  设置PWM时钟 TBCLK = SYSCLKOUT / (HSPCLKDIV × CLKDIV)
static inline void PWM_setHighSpeedClkDiv(PWM_Handle pwmHandle, const PWM_HspClkDiv_e clkDiv);

//! \brief  设置PWM相位寄存器
static inline void PWM_set_TB_PHSEN(PWM_Handle pwmHandle, const PWM_Enable_e Val);
{   
