...
//! @LastEditTime: 2023-08-27 15:43:14
...
typedef struct _ADC_Obj_
{
  ...
  volatile uint16_t ADCCTRL1,   //!< ADC Control Register 1
  volatile uint16_t ADCCTRL2,   //!< ADC Control Register 2
  volatile uint16_t ADCMAXCONV, 
  volatile uint16_t ADCCHSELSEQ1,
  volatile uint16_t ADCCHSELSEQ2,
  volatile uint16_t ADCCHSELSEQ3,
  volatile uint16_t ADCCHSELSEQ4,
  volatile uint16_t ADCASEQSR,
  volatile uint16_t ADCRESULT[16], 
  volatile uint16_t ADCCTRL3,
  volatile uint16_t ADCST,
  volatile uint16_t ADCREFSEL,
