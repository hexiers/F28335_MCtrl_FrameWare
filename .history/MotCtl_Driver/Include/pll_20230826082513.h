...
//! @LastEditTime: 2023-08-26 08:25:13
...
//!
#define SYSCTROL_BASE_ADDR (0x00007011)
...
extern void Sys_disableAdcClock(PLL_Handle sysCtrl_Handle);

//! \brief  Sysisables the CPU timer clock
//! \param[in] clkHandle       The clock (CLK) object handle
//! \param[in] cpuTimerNumber  The CPU timer number
extern void Sys_disableCpuTimerClock(PLL_Handle pllHandle,
                                 const CLK_CpuTimerNumber_e cpuTimerNumber);

//! \brief  SysDisables the crystal oscillator
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableCrystalOsc(PLL_Handle pllHandle);

//! \brief  SysDisables the ECANA clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableEcanaClock(PLL_Handle pllHandle);

//! \brief  SysDisables the ECAP1 clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableEcap1Clock(PLL_Handle pllHandle);

//! \brief  SysDisables the EQEP1 clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableEqep1Clock(PLL_Handle pllHandle);

//! \brief  SysDisables the EQEP2 clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableEqep2Clock(PLL_Handle pllHandle);

//! \brief  SysDisables the GPIO input clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableGpioInputClock(PLL_Handle pllHandle);

//! \brief  SysDisables the HRPWM clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableHrPwmClock(PLL_Handle pllHandle);

//! \brief  SysDisables the I2C clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableI2cClock(PLL_Handle pllHandle);

//! \brief  SysDisables the LIN-A clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableLinAClock(PLL_Handle pllHandle);

//! \brief  SysDisables the pwm clock
//! \param[in] clkHandle   The clock (CLK) object handle
//! \param[in] pwmNumber   The PWM number
extern void Sys_disablePwmClock(PLL_Handle pllHandle, const PWM_Number_e pwmNumber);

//! \brief  SysDisables the SCI-A clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableSciaClock(PLL_Handle pllHandle);

//! \brief  SysDisables the SCI-B clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableScibClock(PLL_Handle pllHandle);

//! \brief  SysDisables the SPI-A clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableSpiaClock(PLL_Handle pllHandle);

//! \brief  SysDisables the SPI-B clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableSpibClock(PLL_Handle pllHandle);

//! \brief  SysDisables the ePWM module time base clock sync signal
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableTbClockSync(PLL_Handle pllHandle);

//! \brief  SysDisables the watchdog halt mode ignore
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_disableWatchDogHaltMode(PLL_Handle pllHandle);



//! \brief  SysEnables the ADC clock
//! \param[in] clkHandle  The clock (CLK) object handle
extern void Sys_enableAdcClock(PLL_Handle pllHandle);

//! \brief  SysEnables the XCLKIN oscillator input
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableClkIn(PLL_Handle pllHandle);

//! \brief  SysEnables the CPU timer clock
//! \param[in] clkHandle       The clock (CLK) object handle
//! \param[in] cpuTimerNumber  The CPU timer number
extern void Sys_enableCpuTimerClock(PLL_Handle pllHandle,
                                const CLK_CpuTimerNumber_e cpuTimerNumber);

//! \brief  SysEnables the crystal oscillator
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableCrystalOsc(PLL_Handle pllHandle);

//! \brief  SysEnables the ECANA clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableEcanaClock(PLL_Handle pllHandle);

//! \brief  SysEnables the ECAP1 clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableEcap1Clock(PLL_Handle pllHandle);

//! \brief  SysEnables the EQEP1 clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableEqep1Clock(PLL_Handle pllHandle);

//! \brief  SysEnables the EQEP2 clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableEqep2Clock(PLL_Handle pllHandle);

//! \brief  SysEnables the GPIO input clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableGpioInputClock(PLL_Handle pllHandle);

//! \brief  SysEnables the pwm clock
//! \param[in] clkHandle   The clock (CLK) object handle
//! \param[in] pwmNumber   The PWM number
extern void Sys_enablePwmClock(PLL_Handle pllHandle, const PWM_Number_e pwmNumber);

//! \brief  SysEnables the SCI-A clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableSciaClock(PLL_Handle pllHandle);

//! \brief  SysEnables the SCI-B clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableScibClock(PLL_Handle pllHandle);

//! \brief  SysEnables the SPI-A clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableSpiaClock(PLL_Handle pllHandle);

//! \brief  SysEnables the SPI-B clock
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableSpibClock(PLL_Handle pllHandle);

//! \brief  SysEnables the ePWM module time base clock sync signal
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableTbClockSync(PLL_Handle pllHandle);

//! \brief  SysEnables the watchdog halt mode ignore
//! \param[in] clkHandle   The clock (CLK) object handle
extern void Sys_enableWatchDogHaltMode(PLL_Handle pllHandle);

//! \brief  SysSets the external clock out prescaler
//! \param[in] clkHandle  The clock (CLK) object handle
//! \param[in] preScaler  The prescaler value
extern void Sys_setClkOutPreScaler(PLL_Handle pllHandle,
                               const CLK_ClkOutPreScaler_e preScaler);

//! \brief  SysSets the low speed peripheral clock prescaler
//! \param[in] clkHandle  The clock (CLK) object handle
//! \param[in] preScaler  The prescaler value
extern void Sys_setLowSpdPreScaler(PLL_Handle pllHandle,
                                const CLK_LowSpdPreScaler_e preScaler);

//! \brief  SysSets the oscillator clock source
//! \param[in] clkHandle  The clock (CLK) object handle
//! \param[in] src        The oscillator clock source
extern void Sys_setOscSrc(PLL_Handle pllHandle, const CLK_OscSrc_e src);

//! \brief  SysSets the oscillator 2 clock source
//! \param[in] clkHandle  The clock (CLK) object handle
//! \param[in] src        The oscillator 2 clock source
extern void Sys_setOsc2Src(PLL_Handle pllHandle, const CLK_Osc2Src_e src);

//! \brief SSys the XCLKIN Clock Source
//! \param[in] clkHandle  The clock (CLK) object handle
//! \paran[in] src        The XCLKIN clock source
extern void Sys_setXClkInSrc(PLL_Handle pllHandle, const CLK_XClkInSrc_e src);

//! \brief  SysSets the timer 2 clock prescaler
//! \param[in] clkHandle  The clock (CLK) object handle
//! \param[in] preScaler  The prescaler value
extern void Sys_setTimer2PreScaler(PLL_Handle pllHandle,
                               const CLK_Timer2PreScaler_e preScaler);

//! \brief  SysSets the timer 2 clock source
//! \param[in] clkHandle  The clock (CLK) object handle
//! \param[in] src        The timer 2 clock source
extern void Sys_setTimer2Src(PLL_Handle pllHandle, const CLK_Timer2Src_e src);

//! \brief  SysSets the watchdog clock source
//! \param[in] clkHandle  The clock (CLK) object handle
//! \param[in] src        The watchdog clock source
extern void Sys_setWatchDogSrc(PLL_Handle pllHandle, const CLK_WdClkSrc_e src);
