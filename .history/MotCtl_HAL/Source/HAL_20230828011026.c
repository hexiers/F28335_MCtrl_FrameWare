...
void HAL_setupAdc(HAL_Handle handle)
{
  ...
  ADC_setRefSource(adcHandle, ADC_ExtRef_1_5V);
  ...
  //================================================================================
  // MAX_CONV
  adcHandle->ADCMAXCONV.bit.MAX_CONV1 = 9;
  adcHandle->ADCCHSELSEQ1.bit.CONV00 = 1;
  adcHandle->ADCCHSELSEQ1.bit.CONV01 = 9;
  adcHandle->ADCCHSELSEQ1.bit.CONV02 = 8;
  adcHandle->ADCCHSELSEQ1.bit.CONV03 = 0;
  adcHandle->ADCCHSELSEQ2.bit.CONV04 = 2;
  adcHandle->ADCCHSELSEQ2.bit.CONV05 = 3;
  adcHandle->ADCCHSELSEQ2.bit.CONV06 = 10;
  adcHandle->ADCCHSELSEQ2.bit.CONV07 = 11;
  adcHandle->ADCCHSELSEQ3.bit.CONV08 = 11;
  adcHandle->ADCCHSELSEQ3.bit.CONV09 = 12;
  //================================================================================
  // ADC_ST_FLAG
  ...
  //================================================================================
  // ADCTRL2
  adcHandle->ADCTRL2.bit.EPWM_SOCA_SEQ1 = 1;
