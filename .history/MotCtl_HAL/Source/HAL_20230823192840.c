...
HAL_Handle HAL_init(void *pMemory, const size_t numBytes)
{
    ...
    obj->pwmHandle = PWM_init((void *)PWM_ePWM1_BASE_ADDR,sizeof(PWM_Obj));
    obj->pwmHandle = PWM_init((void *)PWM_ePWM2_BASE_ADDR,sizeof(PWM_Obj));
    obj->pwmHandle = PWM_init((void *)PWM_ePWM3_BASE_ADDR,sizeof(PWM_Obj));
